...
var grammar = {
    ...
    {"name": "command", "symbols": ["entity"], "postprocess": R({command:"specification", entity:0})},
    ...
    {"name": "relation$subexpression$6$string$2", "symbols": [{"literal":"n"}, {"literal":"e"}, {"literal":"x"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "relation$subexpression$6$string$3", "symbols": [{"literal":"t"}, {"literal":"o"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "form$subexpression$1$string$4", "symbols": [{"literal":"o"}, {"literal":"n"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
